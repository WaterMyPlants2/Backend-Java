...
public class LogoutController {
     ...
     *
     * <br>Example: <a href="http://localhost:8080/api/auth/logout">http://localhost:8080/api/auth/logout</a>
     *
    ...
    @ApiOperation(value = "revoke current user's token", response = void.class)
    @RequestMapping(value = {"/oauth/revoke-token", "/api/auth/logout"},
